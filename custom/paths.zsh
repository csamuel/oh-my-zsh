...
export MAVEN_OPTS="-noverify -javaagent:/Applications/ZeroTurnaround/JRebel/jrebel.jar $MAVEN_OPTS"
...
# Path
export PATH=LOCAL_GEM_PATH:$GROOVY_HOME/bin:$CATALINA_HOME/bin:$HOME/opt/local/bin:/opt/CollabNet_Subversion/bin:$HOME/.gem/ruby/1.8/bin:$HOME/.javagem/java/bin:$HOME/bin:/usr/local/bin:/usr/local/sbin:$HOME/.rvm/bin:$PATH 